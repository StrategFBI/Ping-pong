...
function movePaddles(event) {
  const firstPaddleGoingUp = event.key === moveFirstPaddleKeys.up;
  const firstPaddleGoingDown = event.key === moveFirstPaddleKeys.down;
  const secondPaddleGoingUp = event.key === moveSecondPaddleKeys.up;
  const secondPaddleGoingDown = event.key === moveSecondPaddleKeys.down;
  ...
  if (firstPaddleGoingDown && canFirstPaddleMoveDown) {
    firstPaddle.y += paddleSpeed
  }
  if (secondPaddleGoingUp && canSecondPaddleMoveUp) {
    secondPaddle.y -= paddleSpeed
  }
  if (secondPaddleGoingDown && canSecondPaddleMoveDown) {
    secondPaddle.y += paddleSpeed
  }
}
